...
export const HUMAN_ENTRANCE_DOORS: HumanEntranceDoor[] = [
  ...
  },
  {
    ...
    badgeColor: 'bg-[rgba(10,14,20,0.55)] text-[#ead6b4] border-[rgba(232,195,122,0.4)]',
    borderColor: 'border-[rgba(232,195,122,0.3)] hover:border-[rgba(232,195,122,0.45)]',
...
export const CANONICAL_DOMAINS: CanonicalDomainDetail[] = [
  ...
  },
  {
    ...
    colorScheme: {
      badgeBg: 'bg-[rgba(10,14,20,0.55)] border-[rgba(232,195,122,0.38)] text-[#ead6b4]',
      border: 'border-[rgba(232,195,122,0.26)]',
      text: 'text-[#e8c37a]',
      accent: 'rose',
      gradient: 'from-[rgba(10,14,20,0.4)] via-stone-900 to-stone-950',
    },
...
export const CANONICAL_RESOURCE_TYPES = [
  {
    ...
    color: 'border-[rgba(232,195,122,0.28)] bg-[rgba(10,14,20,0.4)] text-[#ead6b4]',
    iconColor: 'text-[#e8c37a]',
