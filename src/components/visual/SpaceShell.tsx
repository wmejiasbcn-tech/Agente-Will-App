...
> = {
  chat: {
    photo: '/visual-system/space-page09.jpg?v=hq',
    photoMobile: '/visual-system/space-page09-mobile.jpg?v=hq',
    position: '72% 62%',
    marks: [],
  },
  topics: {
    photo: '/visual-system/interior-page05.jpg?v=hq',
    position: '78% 48%',
    marks: [],
  },
  resources: {
    photo: '/visual-system/interior-page10.jpg?v=hq',
    position: '48% 50%',
    marks: [],
  },
  'how-it-works': {
    photo: '/visual-system/waves-page03.jpg?v=hq',
    position: '80% 45%',
    marks: [],
  },
};
  ...
  return (
    <div className="relative min-h-dvh h-dvh overflow-hidden text-[#f4efe6] flex flex-col font-sans selection:bg-amber-900/40 selection:text-amber-100">
      ...
      {cfg.marks.includes('sphere') && (
        <img
          src="/visual-system/sphere-page08.webp?v=hq"
          alt=""
          aria-hidden="true"
      ...
      {cfg.marks.includes('geometry') && (
        <img
          src="/visual-system/geometry-page02.webp?v=hq"
          alt=""
          aria-hidden="true"
      ...
      {cfg.marks.includes('prism') && (
        <img
          src="/visual-system/prism-page07.webp?v=hq"
          alt=""
          aria-hidden="true"
      ...
      {cfg.marks.includes('ribbon') && (
        <img
          src="/visual-system/ribbon-page04.webp?v=hq"
          alt=""
          aria-hidden="true"
      ...
      {cfg.marks.includes('ring') && (
        <img
          src="/visual-system/ring-page11.webp?v=hq"
          alt=""
          aria-hidden="true"
