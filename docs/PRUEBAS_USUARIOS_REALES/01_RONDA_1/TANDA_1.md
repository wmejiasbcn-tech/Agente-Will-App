...
Primera batería de cinco pruebas reales.

## Participantes codificados

### TEST-001
Sanitario — enfermería especializada en infecciosas/VIH (Hospital Clínic).

### TEST-002
Sanitario — enfermería especializada en infecciosas/VIH (Hospital Clínic).

### TEST-003
Comunitario / asociativo — Stop.

### TEST-004
Comunitario / asociativo — Stop.

### TEST-005
Usuario con experiencia Chemsex.

## Objetivo específico de R1A

Obtener una primera lectura desde:
- perspectiva sanitaria especializada;
- perspectiva comunitaria/asociativa;
- perspectiva de persona con experiencia Chemsex.
